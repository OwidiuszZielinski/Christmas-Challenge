...
public class DaySixShoppingList {
    /**
    ...
    public static void main(String[] args) {
        ...
        System.out.println(shoppingList(recipes));
    }

    private static Map<String,Integer> shoppingList(List<Recipe> recipes){
        Map<String, Integer> shoppingList = new HashMap<>();
        for(Recipe x : recipes){
            for(var entry : x.getIngredients().entrySet()){
                if(shoppingList.containsKey(entry.getKey())){
                    shoppingList.put(entry.getKey(), shoppingList.get(entry.getKey())+entry.getValue());
                }
                else
                shoppingList.put(entry.getKey(), entry.getValue());
